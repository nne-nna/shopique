...
export const products = [
    ...
    },
    {
        _id: "aaaan",
        name: "Gold Necklace",
        description: "A versatile power adapter that can charge various Bags, from laptops to phones, with multiple plug types and safety features, ensuring reliable and fast charging.",
        price: 160,
        image: [p_img14],
        category: "Accessories",
        subCategory: "Computers and Laptops",
    ...
    {
        _id: "aaaaz",
        name: "Black Pleated Flare Skirt",
    ...
    {
        _id: "aaabh",
        name: "Gold Shimmer Cawl Neck Top",
        description: "A compact, high-speed flash drive with dual connectors for easy file transfers between USB-A and USB-C Bags.",
        price: 260,
        image: [p_img34],
        category: "Clothes",
        subCategory: "Computers and Laptops",
    ...
    },
    {
        _id: "aaabp",
        name: "Gold Bracelet",
        description: "A compact and high-capacity power bank that charges Bags quickly and efficiently, perfect for travel or emergency use.",
        price: 300,
        image: [p_img42],
        category: "Accessories",
        subCategory: "Computers and Laptops",
    ...
    },
    {
        _id: "aaabq",
        name: "Black Cap",
        description: "A precision stylus pen for seamless note-taking, drawing, and editing on compatible Apple Bags. Features magnetic attachment for easy storage.",
        price: 280,
        image: [p_img43],
        category: "Accessories",
        subCategory: "Mobile Bags",
    ...
    {
        _id: "aaabx",
        name: "Hermes Black Leather Belt",
    ...
    {
        _id: "aaacn",
        name: "Flat Shoes(Various Colors)",
        description: "A professional-grade VR headset with high-resolution visuals, immersive audio, and comfortable design for an unparalleled virtual reality experience.",
        price: 350,
        image: [p_img65],
        category: "Shoes",
